                ...
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a class="btn bg-gradient-primary mb-0" href="/admin/silabus/{{$materi->silabus_academies->id}}/artikel/{{$materi->id}}/edit"><i class="icofont-pencil-alt-2 me-2"></i>Edit</a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0 pb-2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>{!!$materi->artikel_materis->isi_materi!!}</p>
                        </div>
