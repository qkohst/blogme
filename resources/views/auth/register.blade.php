...
<div class="card card-plain">
    ...
    <div class="card-body">
        <form action="#" method="post">
            ...
            <div class="mb-2">
                <input type="password" class="form-control form-control-lg" placeholder="Confirm Password" aria-label="Confirm Password" name="confirm_password">
            </div>
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-3 mb-0">Register</button>
            </div>
        </form>
    </div>
    ...
    <!-- <div class="row px-xl-3 px-sm-2 px-1">
